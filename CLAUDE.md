...
This project is indexed by GitNexus as **ADP** (10740 symbols, 17167 relationships, 194 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
