...
export default function IntegrationForm({ apps, defaultSourceId, onSave, onCancel, saving }: Props) {
  ...
  const sel: React.CSSProperties = { padding: "5px 8px", fontSize: 12, border: "1px solid #ccc", borderRadius: 4 };
  ...
  return (
    <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: 10, padding: 14 }}>
      ...
      <label style={{ fontSize: 12, color: "#555" }}>Source Application *
      ...
      <label style={{ fontSize: 12, color: "#555" }}>Target Application *
      ...
      <label style={{ fontSize: 12, color: "#555" }}>Integration Type
      ...
      <div style={{ display: "flex", gap: 8 }}>
        <button type="submit" disabled={saving} style={{ fontSize: 12, padding: "5px 14px", background: "#1168BD", color: "#fff", border: "none", borderRadius: 4, cursor: "pointer" }}>
          {saving ? "Saving…" : "Save"}
        </button>
        <button type="button" onClick={onCancel} style={{ fontSize: 12, padding: "5px 12px", background: "#f0f0f0", border: "1px solid #ccc", borderRadius: 4, cursor: "pointer" }}>
          Cancel
        </button>
      </div>
    </form>
