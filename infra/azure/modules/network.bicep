// VNet + delegated subnets + private DNS zone (ADP-fnv.2, extended by
// ADP-fnv.4). One VNet, two delegated subnets: Postgres Flexible Server and
// the Container Apps environment -- so the API/Keycloak container apps
// reach Postgres privately with no public endpoint on the database at all.

@description('Azure region.')
param location string

@description('VNet name.')
param vnetName string = 'adp-vnet'
...
param privateDnsZoneName string = 'adp.private.postgres.database.azure.com'
