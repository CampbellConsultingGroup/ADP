    ...
    def emit(self, span_data: ExtractionSpan) -> None:
        ...
        try:
            ...
            with tracer.start_as_current_span("adp.intake.extraction") as span:
                span.set_attribute("adp.operation_id", span_data.operation_id)
                ...
                span.set_attribute("adp.input_tokens", span_data.input_tokens)
                span.set_attribute("adp.output_tokens", span_data.output_tokens)
                span.set_attribute("adp.cost_usd", span_data.cost_usd)
                ...
                span.set_attribute("adp.latency_ms", span_data.latency_ms)
                ...
                if span_data.error:
                    ...
                    span.set_attribute("adp.error", span_data.error)
