...
_EXPECTED: dict[tuple[PersonaRole, ActionType], bool] = {
    ...
    # read/write_application_risk: architects (solution & technical) + enterprise;
    # reviewer holds NEITHER — risk data is sensitive, not open to every reader (v1.2.0)
    (PersonaRole.ENTERPRISE_ARCHITECT, ActionType.READ_APPLICATION_RISK): True,
    (PersonaRole.SOLUTION_ARCHITECT, ActionType.READ_APPLICATION_RISK): True,
    (PersonaRole.TECHNICAL_ARCHITECT, ActionType.READ_APPLICATION_RISK): True,
    (PersonaRole.REVIEWER, ActionType.READ_APPLICATION_RISK): False,
    (PersonaRole.ENTERPRISE_ARCHITECT, ActionType.WRITE_APPLICATION_RISK): True,
    ...
    # read/write_application_governance: same grant shape as risk/cost — sensitive
    # contract/governance data (v1.4.0)
    (PersonaRole.ENTERPRISE_ARCHITECT, ActionType.READ_APPLICATION_GOVERNANCE): True,
    (PersonaRole.SOLUTION_ARCHITECT, ActionType.READ_APPLICATION_GOVERNANCE): True,
    (PersonaRole.TECHNICAL_ARCHITECT, ActionType.READ_APPLICATION_GOVERNANCE): True,
    (PersonaRole.REVIEWER, ActionType.READ_APPLICATION_GOVERNANCE): False,
    (PersonaRole.ENTERPRISE_ARCHITECT, ActionType.WRITE_APPLICATION_GOVERNANCE): True,
